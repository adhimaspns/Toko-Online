...
<head>
  ...
  {{-- jika ingin menambahkan custom css jika di butuhkan --}}
  @stack('customcss')
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg">Toko <b></b>Online</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong> <a href="https://www.instagram.com/adhimaspns/" target="_blank">Adhimas Pns</a></strong>
  </footer>
...
{{-- jika ingin menambahkan custom script jika di butuhkan --}}
@stack('customscript')
